...
class UserQuizzesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_quiz" do
    assert_difference('UserQuiz.count') do
      post user_quizzes_url, params: { user_quiz: { quiz_id: @user_quiz.quiz_id, user_id: @user_quiz.user_id } }
    end
  ...
  test "should update user_quiz" do
    patch user_quiz_url(@user_quiz), params: { user_quiz: { quiz_id: @user_quiz.quiz_id, user_id: @user_quiz.user_id } }
