...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { document_id: @slide.document_id, image: @slide.image, integer: @slide.integer, order: @slide.order } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { document_id: @slide.document_id, image: @slide.image, integer: @slide.integer, order: @slide.order } }
