...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { content: @option.content, quiz_id: @option.quiz_id } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { content: @option.content, quiz_id: @option.quiz_id } }
